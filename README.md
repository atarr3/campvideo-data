...
- ``data``: This folder contains all data needed to perform both feature extraction and validation.
  ...
  * ``videos``: MP4 files corresponding to YouTube videos used in the study. Data in this folder is used in both the [Feature Extraction](README-FE.md#Feature-Extraction) and [Validation](#Validation) step.
