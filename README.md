...
All figures and tables can be replicated using pre-computed results available in [``results``](results) and the WMP data, however these results cannot be replicated without the YouTube videos as well.
