...
sen12 <- read.dta13(file.path(ROOT, "data", "wmp", "wmp-senate-2012-v1.1.dta"), 
                    convert.factors=F)
sen12 <- sen12[!duplicated(sen12$creative), ]
gov12 <- read.dta13(file.path(ROOT, "data", "wmp", "wmp-gov-2012-v1.1.dta"), 
                    convert.factors=F)
...
sen14 <- read.dta13(file.path(ROOT, "data", "wmp", "wmp-senate-2014-v1.0.dta"), 
                    convert.factors=F)
sen14 <- sen14[!duplicated(sen14$creative), ]
gov14 <- read.dta13(file.path(ROOT, "data", "wmp", "wmp-gov-2014-v1.1.dta"), 
                    convert.factors=F)
