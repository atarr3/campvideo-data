...
## Data
Full replication of the [Prediction](#Prediction) step requires the human-coded labels provided by WMP and the YouTube videos for the ads in MP4 format. Neither of this data can be shared publicly.
